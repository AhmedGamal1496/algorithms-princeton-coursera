...
public class Point implements Comparable<Point> {
    ...
    private class SlopeOrder implements Comparator<Point> {
        public int compare(Point p, Point q) {
            ...
            else if (Point.this.slopeTo(p) == Point.this.slopeTo(q)) return 0;
            else return -1; */
        }
    }
    ...
    public static void main(String[] args) {
        ...
        StdOut.println("The slope of r and (3,3) is " + r.slopeTo(new Point(3, 3)));
        StdOut.println();

        StdOut.println("compareTo function: ");
        StdOut.println("Positive: " + r.compareTo(new Point(1, 1)));
        StdOut.println("Zero: " + r.compareTo(new Point(1, 2)));
        StdOut.println("Negative: " + r.compareTo(new Point(4, 4)));
        StdOut.println("Negative: " + r.compareTo(new Point(1, 3)));
        StdOut.println("Negative: " + r.compareTo(new Point(0, 5)));
        StdOut.println("Positive: " + r.compareTo(new Point(0, 2)));
        StdOut.println("Negative: " + r.compareTo(new Point(2, 2)));
    }
}
